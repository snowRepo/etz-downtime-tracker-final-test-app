            ...
            <div class="flex items-center justify-between w-full">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div class="hidden md:block relative" x-data="{ userMenuOpen: false }">
                        <button @click="userMenuOpen = !userMenuOpen" type="button" class="flex items-center justify-center w-10 h-10 rounded-full bg-blue-600 text-white font-semibold hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors" title="<?= htmlspecialchars($currentUser['full_name']) ?>">
                        ...
                        <div x-show="userMenuOpen" @click.away="userMenuOpen = false" x-transition class="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 py-1 z-50" style="display: none;">
                            ...
                            <a href="../public/admin/" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">
    ...
    <div x-show="mobileMenuOpen" 
        ...
        <div class="pt-4 pb-3 border-t border-gray-200 dark:border-gray-700">
            ...
            <div class="mt-3 px-2 space-y-1">
                <?php if ($currentUser['role'] === 'admin'): ?>
                <a href="../public/admin/" class="block px-3 py-2 rounded-lg text-base font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-150">
                    <i class="fas fa-user-shield mr-2"></i>Admin Panel
                </a>
                <?php endif; ?>
