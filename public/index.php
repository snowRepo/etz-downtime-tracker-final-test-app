...
try {
    ...
    $total_query = $pdo->query("SELECT COUNT(*) FROM incidents");
    $total = $total_query->fetchColumn();

    // Resolved incidents
    $resolved_query = $pdo->query("SELECT COUNT(*) FROM incidents WHERE status = 'resolved'");
    $resolved = $resolved_query->fetchColumn();

    // Pending incidents
    $pending_query = $pdo->query("SELECT COUNT(*) FROM incidents WHERE status = 'pending'");
    $pending = $pending_query->fetchColumn();

    // Get incidents with service and affected companies
    $recent_incidents = $pdo->query("
        SELECT 
            ...
            COUNT(DISTINCT c.company_id) as incident_count,
    ...
    <main class="py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <h1 class="text-2xl font-bold leading-7 text-gray-900 dark:text-white sm:text-3xl sm:truncate">
                        Dashboard</h1>
                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Monitor and manage downtime incidents
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 mb-8">
                ...
                <div class="stat-card bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 overflow-hidden rounded-xl"
                ...
                <div class="stat-card bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 overflow-hidden rounded-xl"
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex-shrink-0">
                                <div
                                    class="w-12 h-12 bg-yellow-50 dark:bg-yellow-900/30 rounded-lg flex items-center justify-center">
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-gray-50 dark:bg-gray-900/50">
                            <tr>
                                ...
                                <th scope="col"
                                    class="px-6 py-3 text-center text-xs font-medium text-gray-600 dark:text-gray-400 uppercase tracking-wider">
                                    Status
                                </th>
                            </tr>
                        </thead>
                                ...
                                <tr>
                                    <td colspan="5" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center justify-center">
                                            ...
                                            <p class="text-sm font-medium text-gray-500 dark:text-gray-400">No incidents
                                                found</p>
                                            <p class="text-xs text-gray-400 dark:text-gray-500 mt-1">All systems operational
                                            </p>
                                        </div>
                                    </td>
                                </tr>
                                    ...
                                    <tr class="table-row-hover">
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div
                                                    class="flex-shrink-0 h-9 w-9 bg-blue-50 rounded-lg flex items-center justify-center">
