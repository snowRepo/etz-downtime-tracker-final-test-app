    ...
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="text-center">
                <img src="../src/assets/logo1.png" alt="eTranzact Logo" class="mx-auto h-24 w-auto">
            ...
            <div class="bg-white dark:bg-gray-800 shadow-lg rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                    ...
                    <?php if ($error): ?>
                        <div class="mb-6 bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 rounded-lg p-4">
                            <div class="flex items-center">
                                ...
                                <span class="text-sm font-medium text-red-800 dark:text-red-300"><?= htmlspecialchars($error) ?></span>
                            </div>
                        </div>
                    <?php endif; ?>
                ...
                <div class="px-8 py-4 bg-gray-50 dark:bg-gray-900/50 border-t border-gray-200 dark:border-gray-700">
                    <p class="text-xs text-center text-gray-500 dark:text-gray-400">
                        Default credentials: <span class="font-mono">admin / Admin@123</span>
                    </p>
                </div>
            </div>
